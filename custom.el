(custom-set-variables
 ...
 '(dimmer-prevent-dimming-predicates '(helm--alive-p window-minibuffer-p))
   ...
   (lambda nil
     (let
       ...
       (concat
        ...
        (propertize " " 'face 'default)))) t)
 '(eshell-prompt-regexp "^.*❯ " t)
 '(eshell-save-history-on-exit t t)
 '(eshell-scroll-to-bottom-on-input 'all t)
 ...
 '(minibuffer-frame-alist '((width . 80) (height . 3)))
...
Entered on %U
 ...
 '(zoom-ignored-major-modes '(ranger-mode neotree-mode)))
(custom-set-faces
