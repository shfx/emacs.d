...
(use-package lsp-mode
  ...
  :custom
  (lsp-client-packages
   '( lsp-bash lsp-css lsp-crates lsp-docker lsp-dockerfile
      lsp-elm lasp-emmet lsp-emmet lsp-eslint lsp-eslint lsp-go
      lsp-grammarly lsp-javascript lsp-just lsp-jq lsp-json
      lsp-lisp lsp-lua lsp-lua lsp-lua lsp-markdown lsp-marksman
      lsp-mdx lsp-ocaml lsp-postgres lsp-rust lsp-semgrep lsp-sql
      lsp-svelte lsp-terraform lsp-toml lsp-typst lsp-yaml lsp-zig))
