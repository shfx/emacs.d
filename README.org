...
(use-package lsp-mode
  ...
  (lsp-eslint-server-command (list "node" (concat (expand-file-name user-emacs-directory) "var/lsp/server/eslint/unzipped/extension/server/out/eslintServer.js") "--stdio" "--max-old-space-size=80000"))
...
(use-package lsp-tailwindcss
  ...
  :init
  :custom
  ;; You might want to set it in dir-locals to someing else than nil
  (lsp-tailwindcss-experimental-config-file nil)
  (lsp-tailwindcss-add-on-mode t)
  (lsp-tailwindcss-major-modes
   '(web-mode html-mode css-mode typescript-ts-mode tsx-ts-mode svelte-ts-mode)))
#+end_src
