...
#+begin_src emacs-lisp
(defun +remove-slant-attribute (&optional theme)
...
(use-package kanagawa-theme
  ...
  :demand t
  :hook
  (after-enable-theme . +remove-slant-attribute)
  :custom
  (frame-background-mode 'dark)
  :config
  (set-face-attribute 'default nil :font "JetBrains Mono" :weight 'normal :height 160)
