...
brew install emacs-plus@29 --with-no-frame-refocus --with-xwidgets --with-imagemagick --with-native-comp --with-savchenkovaleriy-big-sur-icon
#+END_SRC
...
(use-package all-the-icons-ibuffer
  ...
  (all-the-icons-ibuffer-formats
   '((mark
      modified read-only locked " " (icon 2 2)
      (name 18 18 :left :elide) " "
      (size-h 9 -1 :right) " " (mode+ 16 16 :left) " "
...
(use-package lsp-mode
  ...
  (lsp-clients-typescript-preferences
   '(:includeCompletionsForModuleExports t :generateReturnInDocTemplate t))
...
(use-package chatgpt-shell
  :custom
  ;; (chatgpt-shell-openai-key "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")
  (chatgpt-shell-openai-key  "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")
...
(use-package tree-sitter
  :custom-face
  (font-lock-preprocessor-face ((t (:foreground "#9c91e4" :weight normal))))
  :config
  (add-to-list
...
(use-package treesit-auto
  :hook
  ((python-ts-mode js-ts-mode rustic-ts-mode json-ts-mode typescript-ts-mode) . #'my/bring-previous-mode-hooks)
  :custom
