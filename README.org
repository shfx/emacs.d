...
(use-package framemove
  :quelpa (framemove :fetcher github :host github :repo "emacsmirror/framemove")
  :custom
...
(use-package kanagawa-theme
  ...
  :custom-face
  (vertical-border ((t (:foreground "#101014"))))
  :config
  (load-theme 'kanagawa t)

  (defvar my/kanawaga-theme-italic-fonts
    '(font-lock-string-face
      ...
      tree-sitter-hl-face:keyword.compiler
      font-lock-keyword-face))

  (dolist (face my/kanawaga-theme-italic-fonts)
    (when (facep face)
