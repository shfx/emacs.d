...
(use-package tree-sitter
  ...
  :functions (global-tree-sitter-mode tree-sitter-hl-mode)
...
** COMMENT All the icons + complementary ([[https://github.com/domtronn/all-the-icons.el][link]])
...
(use-package all-the-icons
  ...
  :custom
  (image-cache-eviction-delay nil)
