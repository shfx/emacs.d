...
(use-package fancy-compilation
  :ensure (fancy-compilation :host codeberg :url "ideasman42/emacs-fancy-compilation")
  :preface
  (defun my/fancy-comp ()
...
(use-package flycheck-inline-mode
  :ensure (flycheck-inline-mode :fetcher github :repo "flycheck/flycheck-inline" :main "flycheck-inline.el")
...
;; (defun my/lsp-signature-quick-peek-dispay (str)
;;   "Use quick-peek to show the STR signatureHelp string."
;;   (if str
;;       (let ((ov (quick-peek-overlay-ensure-at (- (point) 1))))
;;         (setf (quick-peek-overlay-contents ov) str)
;;         (quick-peek-update ov))
;;     (quick-peek-hide)))

;; (defun my/lsp-signature-overlay-dispay (str)
;;   "Use flycheck-inline to show the STR signatureHelp string."
;;   (if str
;;       (let ((msg (propertize str 'face 'flycheck-inline-info)))
;;         (flycheck-inline-phantom-display msg))
...
(use-package lsp-mode
  ...
  ;; (lsp-signature-function #'my/lsp-signature-dispay)
...
(use-package emacs
  ...
  :if (and
       ...
       (not (file-exists-p "~//Library/Fonts/JetBrainsMono[wght].ttf")))
...
(use-package emacs
  ...
  :if (eq system-type 'gnu/linux)
  :config
  (when (not (file-exists-p "~/.local/share/fonts/fonts/webfonts/JetBrainsMono-Light.woff2"))
...
(use-package dimmer
  ...
  ;; Disabling corfu dimming
  ;; https://github.com/gonewest818/dimmer.el/issues/62#issuecomment-1093836001
  (defun corfu-frame-p ()
  ...
  (define-advice dimmer-config-change-handler
      (:override ())
